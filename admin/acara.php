...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO acara (nama_acara, tanggal_acara, tempat_acara, quantity, id_wilayah, id_budaya, harga, deskripsi, gambar_acara)
    VALUES ('$nama_acara', '$tanggal_acara', '$tempat_acara', '$quantity', '$id_wilayah', '$id_budaya', '$harga', '$deskripsi', " . ($gambar_acara ? "'$gambar_acara'" : "NULL") . ")";
...
<body>    
    ...
    <div class="container">
        ...
        <form method="post" class="admin-form" enctype="multipart/form-data">
            ...
            Gambar Acara: <input type="file" name="gambar_acara" accept="image/*" class="admin-input"><br><br>
...
<table class="admin-table">
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        if (!empty($row['gambar_acara'])) {
            echo "<td><img src='/MY_NUSANTARA/admin/uploads/" . htmlspecialchars($row['gambar_acara']) . "' alt='Gambar Acara' style='max-width: 100px; max-height: 100px;'></td>";
        } else {
